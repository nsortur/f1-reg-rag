...
def main(llm, debug=False, fresh=False):
    milvus_host = "localhost"
    milvus_port = 19530
    backend = Backend(model_name=llm, milvus_host=milvus_host, milvus_port=milvus_port, debug=debug, fresh=fresh)
...
if __name__ == "__main__":
    ...
    main(args.llm, debug=args.debug, fresh=args.fresh)
